...
def main(input_directory, input_filepath, search_tool, plddt_cutoff, output_directory):
    ...
    if inputs_valid(input_directory, input_filepath, search_tool, plddt_cutoff, output_directory):
        ...
        data = calculate_site_dists(data, plddt_cutoff)
...
def inputs_valid(input_directory, input_filename, search_tool, plddt_cutoff, output_directory):
